...
public sealed class OkkoVoucherParser : IVoucherProviderParser
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var region in context.VoucherRegions)
        {
            ...
            if (fuelType == FuelType.Unknown && !string.IsNullOrEmpty(qrPayload))
                fuelType = ParseFuelTypeFromQr(qrPayload);
    ...
    private static FuelType ParseFuelTypeFromQr(string qrPayload)
    {
        ...
        if (match.Success)
        {
            ...
            {
                "9018" or "9518" or "45290" => FuelType.Diesel,
                "9015" or "9016" or "9515" or "9009" => FuelType.Gasoline95,
                "9019" or "9020" => FuelType.LPG,
                _ => FuelType.Unknown
            };
        }
